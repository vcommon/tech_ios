...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_framework "${BUILT_PRODUCTS_DIR}/ACEExpandableTextCell/ACEExpandableTextCell.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/WTPhotoBrowser/WTPhotoBrowser.framework"
